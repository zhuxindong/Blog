			...
			<div id="uploadpic" style="display: none;">
				...
				<div class="panel panel-info">
				  ...
				  <div class="panel-body">
				    	<form action="uploadpic1" method="post" enctype="multipart/form-data" class="a-upload">
		...
		<div id="main-info">
			...
			<div id="input-text">
				<form action="publishMessage" method="post">
					...
					<button type="button" class="btn" id="publishmessage" style="margin-left:500px; margin-top:3px;margin-right: 30px;width: 120px;">发布</button>
				</form>
			</div>



			<div class="panel panel-default" id="newmessage" style="display: none;">
			  <div class="panel-heading">${sessionScope.student.getName()}</div>
			...
			<div class="panel panel-default">
			  <div class="panel-heading">面板标题2</div>
			  <div class="panel-body">
			    面板内容2
			  </div>
			</div>
